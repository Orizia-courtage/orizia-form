...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.orizia-courtage.fr/images/og-scpi.webp',
        width: 1200,
        height: 630,
...
const CHIFFRES = [
  ...
  { value: '⏱️\u00A08–10 ans', label: 'Durée de détention recommandée', icon: '' },
];
      ...
      <main>
        ...
        <section className="fin-hero ae-hero">
          ...
          <div className="ae-hero-inner fin-hero-inner">
            ...
            <span className="fin-badge">🏗️ Pierre-papier & immobilier de rendement</span>
