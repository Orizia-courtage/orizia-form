...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.orizia-courtage.fr/images/og-assurance-habitation.webp',
        width: 1200,
        height: 630,
  ...
  '@graph': [
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Assurance Habitation', item: 'https://www.orizia-courtage.fr/assurer/assurance-habitation' }
      ]
    },
    {
      '@type': 'Service',
        ...
        <section className="fin-hero ae-hero">
          ...
          <div className="ae-hero-inner">
            ...
            <div className="ae-hero-trust">
              ...
              <span>🛡️ Interlocutrice 100% dédiée</span>
