...
const JALONS_DESKTOP = [
  ...
  { label: 'Risques', pct: 35, id: 'section-risques' },
  { label: 'Fiscalité', pct: 50, id: 'section-fiscalite' },
  { label: 'Accompagnement', pct: 65, id: 'section-accompagnement' },
  { label: 'Auto-évaluation', pct: 78, id: 'section-autoevaluation' },
];

const JALONS_MOBILE = [
  { label: 'Fiscalité', pct: 50, displayPct: 25, id: 'section-fiscalite' },
  { label: 'Accompagnement', pct: 65, displayPct: 50, id: 'section-accompagnement' },
